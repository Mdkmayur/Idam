    ...
    <main className="max-w-3xl mx-auto px-6 py-10">
      ...
      <div className="mt-8 rounded-3xl border border-idam-plat bg-white p-6 shadow-soft">
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div>
            <Label>Email</Label>
            <TextInput value={email} onChange={(e) => setEmail(e.target.value)} placeholder="you@example.com" type="email" />
          </div>
          <div>
            <Label>Phone</Label>
        ...
        <div className="mt-4">
          <Label>Message</Label>
          <TextArea value={message} onChange={(e) => setMessage(e.target.value)} placeholder="Tell us what you want to build, timeline, budget range, and any requirements." />
        </div>
